...
(function ($) {
    ...
    Modal.prototype.createContainerElement = function () {
        ...
        this.element.innerHTML = '<div 测试开发干货 '+'style="max-width: 800px;"'+' class="modal-dialog ' + this.props.modalDialogClass + '" role="document">' +
    ...
    $.extend({
        ...
        showAlert: function (props) {
            props.footer = '<button type="button" class="btn btn-primary" data-dismiss="modal">知道了</button>'
